// (c) 1- maior preço primeiro; havendo empates, 2- nome do produto em ordem crescente;
//  e, ocorrendo empates, 3- ordem crescente de data: void ordena_c(TPROD **vet, int n);
